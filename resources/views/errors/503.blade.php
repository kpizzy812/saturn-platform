...
<div class="flex flex-col items-center justify-center min-h-screen">
    <div>
        <p class="font-mono font-semibold text-7xl text-warning">503</p>
        <h1 class="mt-4 font-bold tracking-tight text-white">We are working on serious things.</h1>
        <p class="text-base leading-7 text-neutral-400">Service Unavailable. Be right back. Thanks for your patience.</p>
