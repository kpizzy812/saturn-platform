...
return [
    'saturn' => [
        ...
        'base_config_path' => env('BASE_CONFIG_PATH', '/data/saturn'),
        'registry_url' => env('REGISTRY_URL', 'ghcr.io'),
        'helper_image' => env('HELPER_IMAGE', env('REGISTRY_URL', 'ghcr.io').'/coollabsio/saturn-helper'),
        'realtime_image' => env('REALTIME_IMAGE', env('REGISTRY_URL', 'ghcr.io').'/coollabsio/saturn-realtime'),
        'is_windows_docker_desktop' => env('IS_WINDOWS_DOCKER_DESKTOP', false),
        'cdn_url' => env('CDN_URL', ''),
        'versions_url' => env('VERSIONS_URL', ''),
        'upgrade_script_url' => env('UPGRADE_SCRIPT_URL', ''),
        'releases_url' => '',
    ],
    ...
    'services' => [
        // Using GitHub raw URL for service templates (keeping for Docker registry compatibility)
