        ...
        requestBody: new OA\RequestBody(
            ...
            content: new OA\MediaType(
                ...
                schema: new OA\Schema(
                    ...
                    properties: [
                        new OA\Property(property: 'server_uuid', type: 'string', description: 'UUID of the server'),
                        new OA\Property(property: 'project_uuid', type: 'string', description: 'UUID of the project'),
                        new OA\Property(property: 'environment_name', type: 'string', description: 'Name of the environment. You need to provide at least one of environment_name or environment_uuid.'),
                        new OA\Property(property: 'environment_uuid', type: 'string', description: 'UUID of the environment. You need to provide at least one of environment_name or environment_uuid.'),
                        ...
                        new OA\Property(property: 'destination_uuid', type: 'string', description: 'UUID of the destination if the server has multiple destinations'),
                        ...
                        new OA\Property(property: 'instant_deploy', type: 'boolean', description: 'Instant deploy the database'),
                    ],
                ),
            )
        ),
            ...
            content: new OA\MediaType(
                ...
                schema: new OA\Schema(
                    ...
                    properties: [
                        ...
                        new OA\Property(property: 'environment_uuid', type: 'string', description: 'UUID of the environment. You need to provide at least one of environment_name or environment_uuid.'),
                        new OA\Property(property: 'destination_uuid', type: 'string', description: 'UUID of the destination if the server has multiple destinations'),
                        new OA\Property(property: 'mongo_conf', type: 'string', description: 'MongoDB conf'),
                        new OA\Property(property: 'mongo_initdb_root_username', type: 'string', description: 'MongoDB initdb root username'),
                        new OA\Property(property: 'name', type: 'string', description: 'Name of the database'),
                        new OA\Property(property: 'description', type: 'string', description: 'Description of the database'),
                        new OA\Property(property: 'image', type: 'string', description: 'Docker Image of the database'),
                        new OA\Property(property: 'is_public', type: 'boolean', description: 'Is the database public?'),
