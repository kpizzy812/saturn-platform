...
#[OA\Info(title: 'Saturn Platform', version: '0.1')]
#[OA\Server(url: 'https://app.example.com/api/v1', description: 'Saturn Platform Cloud API. Change the host to your own instance if you are self-hosting.')]
#[OA\SecurityScheme(
    type: 'http',
    scheme: 'bearer',
...
class OpenApi
{
    ...
    // for the Saturn Platform API. It is not a controller and does
