                ...
                new OA\MediaType(
                    ...
                    schema: new OA\Schema(
                        ...
                        properties: [
                            ...
                            'instant_deploy' => ['type' => 'boolean', 'description' => 'Deploy instantly after creation.'],
                        ],
                    )
                ),
            ]
                ...
                new OA\MediaType(
                    ...
                    schema: new OA\Schema(
                        ...
                        properties: [
                            ...
                            'environment_name' => ['type' => 'string', 'description' => 'The environment name.'],
                            'environment_uuid' => ['type' => 'string', 'description' => 'The environment UUID.'],
                            'dockerfile' => ['type' => 'string', 'description' => 'The Dockerfile content (base64 encoded).'],
                            'instant_deploy' => ['type' => 'boolean', 'description' => 'Deploy instantly after creation.'],
                        ],
                    )
                ),
                ...
                new OA\MediaType(
                    ...
                    schema: new OA\Schema(
                        ...
                        properties: [
                            ...
                            'environment_name' => ['type' => 'string', 'description' => 'The environment name.'],
                            'environment_uuid' => ['type' => 'string', 'description' => 'The environment UUID.'],
                            'docker_compose_raw' => ['type' => 'string', 'description' => 'The Docker Compose raw content (base64 encoded).'],
                            'instant_deploy' => ['type' => 'boolean', 'description' => 'Deploy instantly after creation.'],
                        ],
                    )
                ),
