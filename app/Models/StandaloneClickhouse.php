 ...
 * @property string|null $clickhouse_user
 * @property string|null $clickhouse_password
 * @property string|null $clickhouse_db
...
class StandaloneClickhouse extends BaseModel
{
     ...
     */
    protected $fillable = [
        'uuid', 'name', 'description', 'clickhouse_user', 'clickhouse_password', 'clickhouse_db',
        'image', 'status', 'is_public', 'public_port', 'ports_mappings',
    ...
    public function getActivitylogOptions(): LogOptions
    {
        return LogOptions::defaults()
            ->logOnly(['name', 'description', 'clickhouse_db', 'clickhouse_user', 'status'])
            ->logOnlyDirty()
            ->dontSubmitEmptyLogs();
    }
