...
#[OA\Schema(
    ...
    properties: [
        ...
        new OA\Property(property: 'private_key', type: 'string', format: 'private-key'),
        new OA\Property(property: 'public_key', type: 'string', description: 'The public key of the private key.'),
        new OA\Property(property: 'fingerprint', type: 'string', description: 'The fingerprint of the private key.'),
        new OA\Property(property: 'is_git_related', type: 'boolean'),
...
class PrivateKey extends BaseModel
{
    ...
    public static function generateNewKeyPair($type = 'rsa')
    {
        try {
            ...
            $description = 'Created by Saturn Platform';
