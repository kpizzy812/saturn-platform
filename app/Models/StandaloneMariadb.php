...
class StandaloneMariadb extends BaseModel
{
     ...
     */
    protected $fillable = [
        'uuid', 'name', 'description', 'mariadb_user', 'mariadb_password', 'mariadb_root_password',
        'mariadb_database', 'mariadb_conf', 'image', 'status', 'is_public', 'public_port',
    ...
    public function getActivitylogOptions(): LogOptions
    {
        return LogOptions::defaults()
            ->logOnly(['name', 'description', 'mariadb_database', 'mariadb_user', 'status'])
            ->logOnlyDirty()
            ->dontSubmitEmptyLogs();
    }
