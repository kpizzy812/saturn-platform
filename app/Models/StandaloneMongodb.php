...
class StandaloneMongodb extends BaseModel
{
     ...
     */
    protected $fillable = [
        'uuid', 'name', 'description', 'mongo_initdb_root_username', 'mongo_initdb_root_password',
        'mongo_db', 'mongo_conf', 'image', 'status', 'is_public', 'public_port', 'ports_mappings',
    ...
    public function getActivitylogOptions(): LogOptions
    {
        return LogOptions::defaults()
            ->logOnly(['name', 'description', 'mongo_db', 'status'])
            ->logOnlyDirty()
            ->dontSubmitEmptyLogs();
    }
