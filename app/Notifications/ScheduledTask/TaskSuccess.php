...
class TaskSuccess extends CustomEmailNotification
{
    ...
    public function toMail(): MailMessage
    {
        ...
        $mail->subject("Saturn Platform: Scheduled task ({$this->task->name}) succeeded.");
    ...
    {
        $message = "Saturn Platform: Scheduled task ({$this->task->name}) succeeded.";
        if ($this->url) {
            $buttons[] = [
                'text' => 'Open task in Saturn Platform',
                'url' => (string) $this->url,
            ];
        }
