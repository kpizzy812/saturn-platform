...
class HetznerDeletionFailed extends CustomEmailNotification
{
    ...
    public function toDiscord(): DiscordMessage
    {
        return new DiscordMessage(
            title: ':cross_mark: Saturn Platform: [ACTION REQUIRED] Failed to delete Hetzner server',
            description: "Failed to delete Hetzner server #{$this->hetznerServerId} from Hetzner Cloud.\n\n**Error:** {$this->errorMessage}\n\nThe server has been removed from Saturn Platform, but may still exist in your Hetzner Cloud account. Please check your Hetzner Cloud console and manually delete the server if needed.",
    ...
    {
        return [
            'message' => "Saturn Platform: [ACTION REQUIRED] Failed to delete Hetzner server #{$this->hetznerServerId} from Hetzner Cloud.\n\nError: {$this->errorMessage}\n\nThe server has been removed from Saturn Platform, but may still exist in your Hetzner Cloud account. Please check your Hetzner Cloud console and manually delete the server if needed.",
        ];
    }
    ...
    public function toPushover(): PushoverMessage
    {
        return new PushoverMessage(
            ...
            level: 'error',
            message: "[ACTION REQUIRED] Failed to delete Hetzner server #{$this->hetznerServerId}.\n\nError: {$this->errorMessage}\n\nThe server has been removed from Saturn Platform, but may still exist in your Hetzner Cloud account. Please check and manually delete if needed.",
        );
    }
    ...
    public function toSlack(): SlackMessage
    {
        return new SlackMessage(
            title: 'Saturn Platform: [ACTION REQUIRED] Hetzner Server Deletion Failed',
            description: "Failed to delete Hetzner server #{$this->hetznerServerId} from Hetzner Cloud.\n\nError: {$this->errorMessage}\n\nThe server has been removed from Saturn Platform, but may still exist in your Hetzner Cloud account. Please check your Hetzner Cloud console and manually delete the server if needed.",
