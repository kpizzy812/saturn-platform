...
class HighDiskUsage extends CustomEmailNotification
{
    ...
    public function toDiscord(): DiscordMessage
    {
        ...
        $message->addField('What to do?', '[Link](#/knowledge-base/server/automated-cleanup)', true);
    ...
    {
        return [
            'message' => "Saturn Platform: Server '{$this->server->name}' high disk usage detected!\nDisk usage: {$this->disk_usage}%. Threshold: {$this->server_disk_usage_notification_threshold}%.\nPlease cleanup your disk to prevent data-loss.\nHere are some tips: #/knowledge-base/server/automated-cleanup.",
        ];
    }
    ...
    public function toPushover(): PushoverMessage
    {
        return new PushoverMessage(
            ...
            buttons: [
                ...
                'Tips for cleanup' => '#/knowledge-base/server/automated-cleanup',
            ],
        );
    }
    ...
    public function toSlack(): SlackMessage
    {
        ...
        $description .= "Tips for cleanup: #/knowledge-base/server/automated-cleanup\n";
