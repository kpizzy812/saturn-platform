...
class DockerCleanupSuccess extends CustomEmailNotification
{
    ...
    public function toMail(object $notifiable): MailMessage
    {
        ...
        $mail->subject("Saturn Platform: Docker cleanup job succeeded on {$this->server->name}");
    ...
    public function toDiscord(): DiscordMessage
    {
        return new DiscordMessage(
            title: ':white_check_mark: Saturn Platform: Docker cleanup job succeeded on '.$this->server->name,
    ...
    {
        return [
            'message' => "Saturn Platform: Docker cleanup job succeeded on {$this->server->name}!\n\n{$this->message}",
        ];
    }
    ...
    public function toSlack(): SlackMessage
    {
        return new SlackMessage(
            title: 'Saturn Platform: Docker cleanup job succeeded',
