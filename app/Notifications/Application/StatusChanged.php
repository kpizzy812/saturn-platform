...
class StatusChanged extends CustomEmailNotification
{
    ...
    public function toMail(): MailMessage
    {
        ...
        $fqdn = $this->fqdn;
        $mail->subject("Saturn Platform: {$this->resource_name} has been stopped");
    ...
    public function toDiscord(): DiscordMessage
    {
        return new DiscordMessage(
            ...
            description: '[Open Application in Saturn Platform]('.$this->resource_url.')',
    ...
    {
        $message = 'Saturn Platform: '.$this->resource_name.' has been stopped.';

        return [
            'message' => $message,
            'buttons' => [
                [
                    'text' => 'Open Application in Saturn Platform',
