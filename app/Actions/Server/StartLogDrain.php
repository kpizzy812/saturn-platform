...
[FILTER]
    Name                modify
    Match               *
    Set                 saturn.server_name {$server->name}
    Rename              SATURN_APP_NAME saturn.app_name
    Rename              SATURN_PROJECT_NAME saturn.project_name
    Rename              SATURN_SERVER_IP saturn.server_ip
    Rename              SATURN_ENVIRONMENT_NAME saturn.environment_name
[OUTPUT]
    Name nrlogs
    Match *
...
services:
  saturn-log-drain:
    ...
    container_name: saturn-log-drain
