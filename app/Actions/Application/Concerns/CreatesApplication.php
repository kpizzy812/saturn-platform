...
trait CreatesApplication
{
    protected function getCommonAllowedFields(): array
    {
        return [
            ...
            'docker_registry_image_name', 'docker_registry_image_tag', 'build_pack', 'application_type',
    ...
    protected function applyCommonSettings(
        ...
        // Workers: disable health check and skip domain generation
        if ($application->isWorker()) {
            $application->health_check_enabled = false;
            $application->fqdn = null;
            $application->save();
        } elseif ($autogenerateDomain && blank($fqdn)) {
