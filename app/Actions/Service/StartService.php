...
class StartService
{
    ...
    public function handle(Service $service, bool $pullLatestImages = false, bool $stopBeforeStart = false)
    {
        ...
        return remote_process($commands, $service->server, type_uuid: $service->uuid, callEventOnFinish: 'ServiceStatusChanged', callEventData: $service->environment->project->team->id);
    }
}
