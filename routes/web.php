...
Route::middleware(['web', 'auth', 'verified'])->group(function () {
    ...
    // Supports container filtering via ?container=<name> parameter (for multi-container apps)
    ...
    Route::prefix('sources')->group(function () {
        ...
        Route::prefix('github')->group(function () {
            ...
            // The GitHub callback (/source/github/redirect) will fill in the credentials
