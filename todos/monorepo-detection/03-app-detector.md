...
**Файл:** `app/Services/RepositoryAnalyzer/Detectors/AppDetector.php`

## Поддерживаемые фреймворки

### Node.js

| Framework | Dependencies | Default Port | Build Pack |
|-----------|--------------|--------------|------------|
| NestJS | `@nestjs/core` | 3000 | nixpacks |
| Next.js | `next` | 3000 | nixpacks |
| Nuxt | `nuxt` | 3000 | nixpacks |
| Remix | `@remix-run/node` | 3000 | nixpacks |
| Astro | `astro` | 4321 | nixpacks |
| SvelteKit | `@sveltejs/kit` | 3000 | nixpacks |
| Express | `express` | 3000 | nixpacks |
| Fastify | `fastify` | 3000 | nixpacks |
| Hono | `hono` | 3000 | nixpacks |
| Vite+React | `vite`, `react` | 80 | static |
| Vite+Vue | `vite`, `vue` | 80 | static |
| CRA | `react-scripts` | 80 | static |

### Python

| Framework | Dependencies | Default Port | Build Pack |
|-----------|--------------|--------------|------------|
| Django | `django`, `Django` | 8000 | nixpacks |
| FastAPI | `fastapi` | 8000 | nixpacks |
| Flask | `flask`, `Flask` | 5000 | nixpacks |

### Go

| Framework | Dependencies | Default Port | Build Pack |
|-----------|--------------|--------------|------------|
| Fiber | `github.com/gofiber/fiber` | 3000 | nixpacks |
| Gin | `github.com/gin-gonic/gin` | 8080 | nixpacks |
| Echo | `github.com/labstack/echo` | 8080 | nixpacks |
| Plain Go | `go.mod` exists | 8080 | nixpacks |

### Ruby

| Framework | Dependencies | Default Port | Build Pack |
|-----------|--------------|--------------|------------|
| Rails | `rails` | 3000 | nixpacks |
| Sinatra | `sinatra` | 4567 | nixpacks |

### Rust

| Framework | Dependencies | Default Port | Build Pack |
|-----------|--------------|--------------|------------|
| Axum | `axum` | 3000 | nixpacks |
| Actix | `actix-web` | 8080 | nixpacks |
| Plain Rust | `Cargo.toml` exists | 8080 | nixpacks |

### PHP

| Framework | Dependencies | Default Port | Build Pack |
|-----------|--------------|--------------|------------|
| Laravel | `laravel/framework` | 8000 | nixpacks |
| Symfony | `symfony/framework-bundle` | 8000 | nixpacks |

### Elixir

| Framework | Dependencies | Default Port | Build Pack |
|-----------|--------------|--------------|------------|
| Phoenix | `phoenix` | 4000 | nixpacks |

### Java/Kotlin

| Framework | Dependencies | Default Port | Build Pack |
|-----------|--------------|--------------|------------|
| Spring Boot | `spring-boot` (pom.xml/build.gradle) | 8080 | nixpacks |
