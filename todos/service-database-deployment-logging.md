...
4. **Existing Pattern:**
   - Saturn Platform already uses separate tables: `applications`, `services`, `standalone_*`
...
**File:** `app/Actions/Saturn PlatformTask/PrepareSaturn PlatformTask.php`
...
**Note:** Exact implementation depends on PrepareSaturn PlatformTask structure. Need to review file in detail during implementation.
...
### Feature Tests (Run inside Docker: `docker exec saturn php artisan test`)
...
**Details:** `PrepareSaturn PlatformTask` is core to all deployments. Changes here affect everything.

**Mitigation:**
- Review `PrepareSaturn PlatformTask` code in detail before changes
...
- [ ] Review `PrepareSaturn PlatformTask` code
