...
### Прочие критические
- [x] **API tokens видимы в React DevTools** - Settings/Tokens.tsx ✅ (токен очищается из памяти при закрытии модального окна)
- [x] **Broken links** - /terms, /privacy, /support ✅ (ссылки удалены - внутренний продукт)
...
### Mock данные в UI компонентах (исправлено)
- [x] **Applications/Show.tsx - Resource Usage** ✅ (добавлен endpoint /applications/{uuid}/metrics + хук useApplicationMetrics, реальные docker stats через SSH)
...
**Прогресс: ~52 исправлено ✅ | ~29 осталось**
