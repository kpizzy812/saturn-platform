# Saturn Platform Testing Architecture & Patterns
...
Saturn Platform employs **comprehensive testing strategies** using modern PHP testing frameworks to ensure reliability of deployment operations, infrastructure management, and user interactions.
...
- **MUST** run inside Docker container: `docker exec saturn php artisan test`
