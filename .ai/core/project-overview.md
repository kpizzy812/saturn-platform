# Saturn Platform Project Overview

## What is Saturn Platform?

Saturn Platform is an **open-source & self-hostable alternative to Heroku / Netlify / Vercel**. It's a comprehensive deployment platform that helps you manage servers, applications, and databases on your own hardware with just an SSH connection.
...
### **Cloud Version (Paid)**
- Managed Saturn Platform instance
- High availability
- Premium support
