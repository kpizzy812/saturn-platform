# Saturn Platform AI Documentation

Welcome to the Saturn Platform AI documentation hub. This directory contains all AI assistant instructions organized by topic for easy navigation and maintenance.

## Quick Start

- **For Claude Code**: Start with [CLAUDE.md in root directory](../CLAUDE.md)
- **For Cursor IDE**: Check `.cursor/rules/saturn-ai-docs.mdc` which references this directory
...
- **[Project Overview](core/project-overview.md)** - What Saturn Platform is and how it works
- **[Application Architecture](core/application-architecture.md)** - System design and component relationships
- **[Deployment Architecture](core/deployment-architecture.md)** - How deployments work end-to-end, including Saturn Platform Docker Compose extensions (custom fields)
...
- Command: `docker exec saturn php artisan test`
...
→ [core/deployment-architecture.md](core/deployment-architecture.md#saturn-docker-compose-extensions)
...
- Feature tests: `docker exec saturn php artisan test` (requires database, inside Docker)
...
- **Cursor IDE users**: Check `.cursor/rules/saturn-ai-docs.mdc`
