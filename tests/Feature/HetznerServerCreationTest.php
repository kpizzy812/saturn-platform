...
it('validates SSH key array merging logic with Saturn Platform key', function () {
    $saturnKeyId = 123;
    $selectedHetznerKeys = [];
...
it('validates deduplication when Saturn Platform key is also in selected keys', function () {
    $saturnKeyId = 123;
