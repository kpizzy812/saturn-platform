...
it('excludes current version of Saturn Platform infrastructure images from any registry', function () {
    ...
    // Pattern: (^|/)coollabsio/saturn-helper:VERSION$|(^|/)coollabsio/saturn-realtime:VERSION$
    ...
    $infraPattern = "(^|\\/)coollabsio\\/saturn-helper:{$escapedHelperVersion}$|(^|\\/)coollabsio\\/saturn-realtime:{$escapedRealtimeVersion}$";
    $pattern = "/{$infraPattern}/";

    // Current versioned infrastructure images from ANY registry should be PROTECTED
    $protectedImages = [
        // ghcr.io registry
        "ghcr.io/coollabsio/saturn-helper:{$helperVersion}",
        "ghcr.io/coollabsio/saturn-realtime:{$realtimeVersion}",
        // docker.io registry (explicit)
        "docker.io/coollabsio/saturn-helper:{$helperVersion}",
        "docker.io/coollabsio/saturn-realtime:{$realtimeVersion}",
        // No registry prefix (Docker Hub implicit)
        "coollabsio/saturn-helper:{$helperVersion}",
        "coollabsio/saturn-realtime:{$realtimeVersion}",
    ];
    ...
    $oldVersionImages = [
        'ghcr.io/coollabsio/saturn-helper:1.0.11',
        'docker.io/coollabsio/saturn-helper:1.0.10',
        'coollabsio/saturn-helper:1.0.9',
        'ghcr.io/coollabsio/saturn-realtime:1.0.9',
        'ghcr.io/coollabsio/saturn-helper:latest',
        'coollabsio/saturn-realtime:latest',
    ];
...
it('protects current infrastructure images from any registry even when no applications exist', function () {
    ...
    expect(preg_match($pattern, "ghcr.io/coollabsio/saturn-helper:{$helperVersion}"))->toBe(1);
    expect(preg_match($pattern, "docker.io/coollabsio/saturn-helper:{$helperVersion}"))->toBe(1);
    expect(preg_match($pattern, "coollabsio/saturn-helper:{$helperVersion}"))->toBe(1);
    expect(preg_match($pattern, "ghcr.io/coollabsio/saturn-realtime:{$realtimeVersion}"))->toBe(1);

    // Old versions should NOT be protected
    expect(preg_match($pattern, 'ghcr.io/coollabsio/saturn-helper:1.0.11'))->toBe(0);
    expect(preg_match($pattern, 'docker.io/coollabsio/saturn-helper:1.0.11'))->toBe(0);
