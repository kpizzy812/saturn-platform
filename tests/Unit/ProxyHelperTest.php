...
it('identifies saturn as not predefined network', function () {
    expect(isDockerPredefinedNetwork('saturn'))->toBeFalse();
});

it('identifies saturn-overlay as not predefined network', function () {
    expect(isDockerPredefinedNetwork('saturn-overlay'))->toBeFalse();
});
