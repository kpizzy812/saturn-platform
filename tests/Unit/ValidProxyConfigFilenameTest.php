...
test('blocks reserved filename saturn.yaml', function () {
    $rule = new ValidProxyConfigFilename;
    $failed = false;

    $rule->validate('fileName', 'saturn.yaml', function () use (&$failed) {
        $failed = true;
    });
...
test('blocks reserved filename saturn.yml', function () {
    $rule = new ValidProxyConfigFilename;
    $failed = false;

    $rule->validate('fileName', 'saturn.yml', function () use (&$failed) {
        $failed = true;
    });
